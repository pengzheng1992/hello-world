...
public:
	...
	*/
	...
	int highest; // indicate which switch is the highest bit counter for the flow
	int highest2; // indicate which switch is the second highest bit counter for the flow
};
