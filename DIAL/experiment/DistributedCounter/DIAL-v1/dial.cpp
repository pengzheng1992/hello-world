// Author: PZ
// We view all the switch memory along the routing path of a flow as the supplement memory to the local switch memory
// 
...
// NEED SETTING!!!
const int kSwitches = 36; // how many switches we have in the topology file.
...
const int kMaxCountersInSwitch = 100000;
